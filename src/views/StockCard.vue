    ...
    <div class="stock-wrap">
      ...
      <div class="card card-primary">
        <form action="#" id="quickForm">
          <div class="card-body">
            <div class="form-group">
              <label for="exampleNameStock">Название акции</label>
              <input
                type="text"
                name="nameStock"
                class="form-control"
                id="exampleNameStock"
                placeholder="Enter name Stock"
              />
            </div>
            <div class="form-group">
              <label for="exampleNameData">Дата публикации</label>
              <input
                type="date"
                name="nameData"
                class="form-control"
            ...
            <div class="form-group">
              <label for="exampleInputFileGalleryImage">Галерея картинок</label>
              <div class="input-group">
                <div class="custom-file">
                  <input
                    type="file"
                    class="custom-file-input"
                    id="exampleInputFileGalleryImage"
                  />
                  <label class="custom-file-label" for="exampleInputFile"
                    >Choose file</label
                  >
